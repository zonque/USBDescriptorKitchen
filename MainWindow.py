...
class MainFrame(wx.Frame):
	...
	def OnDump(self, event):
		...
		print
		print "/***************************************************************************"
		print "   AUTOMATICALLY GENERATED by USBDescriptorKitchen (%s)" % getVersion()
		print "   When editing, make sure you keep the indentation right"
		print "   and use an editor that doesn't mess around with the linefeeds."
		print
		print "   See http://github.com/zonque/USBDescriptorKitchen/"
		print "   for more information about the tool that was used to generate this file" 
		print " ***************************************************************************/"
		print
